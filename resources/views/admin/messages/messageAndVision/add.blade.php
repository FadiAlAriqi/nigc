    ...
    <div class="row">
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                    <form method="post" action="{{route('admin.messageAndVision.store')}}"  class="forms-sample" enctype="multipart/form-data">
                        @csrf
                        ...
                        <a href="{{route('admin.messageAndVision.index')}}" class="btn bg-pink cancel1">{{__('dashboard.cancel')}}</a>
                    </form>
                </div>
            </div>
        </div>
