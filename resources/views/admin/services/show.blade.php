        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <h4 class="page-title m-0" style="color: #B5A362;">{{__('dashboard.service_details')}}</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="service_ar" id="textarea" class="form-control" rows="3" placeholder="Type your service here" readonly>{{$service->service_ar}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="service_en" id="textarea" class="form-control" rows="3" placeholder="Type your service here" readonly>{{$service->service_en}}</textarea>
                        </div>
                    </div>
