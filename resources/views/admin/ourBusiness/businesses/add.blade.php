        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <h4 class="page-title m-0" style="color: #B5A362;">{{__('dashboard.add_business')}}</h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <form method="post" action="#"  class="forms-sample" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="business_ar" value="{{old('business_ar')}}" id="textarea" class="form-control" rows="3" placeholder="Type your business here"></textarea>
                                @error('business_ar')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="business_en" value="{{old('business_en')}}" id="textarea" class="form-control" rows="3" placeholder="Type your business here"></textarea>
                                @error('business_en')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
