...
@section('navContent')
    <div id="top-content" class="container-fluid">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title" style="text-align: center">{{__('amd.massage_and_vision')}}</div>
    ...
    <div class="text-photo-sc container-fluid blue-bg">
        <div class="row">
            ...
            <div class="col-md-6 text-holder text1">
                <div class="text-box">
                    <h4 style="text-align: center">{{$messageAndVision['title_'.app()->getLocale()]}}</h4>
                    <p style="text-align: start"> {{$messageAndVision['message_'.app()->getLocale()]}} </p>
                </div>
            </div>
        </div>
    </div>
