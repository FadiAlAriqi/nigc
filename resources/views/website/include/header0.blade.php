                    ...
                    @if(app()->getLocale() == 'ar')
                        <div style="height: 1px;" role="main" aria-expanded="false" class="navbar-collapse collapse navbar-collapse-centered" id="bs">
                            <ul class="nav navbar-nav navbar-nav-centered">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#Message_and_vision">{{__('amd.massage_and_vision')}}</a></li>
                                <li class="nav-item"><a class="nav-link" href="#manager_speech">{{__('amd.manager_speech')}}</a></li>
                                <li class="nav-item"><a class="nav-link" href="#about_as">{{__('amd.about')}}</a></li>
                                <li class="nav-item"><a class="nav-link" href="#services">{{__('amd.our_service')}}</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{route('index')}}">{{__('amd.home')}}</a></li>
                            </ul>
                        </div>
                    @else
                        <div style="height: 1px;" role="main" aria-expanded="false" class="navbar-collapse collapse navbar-collapse-centered" id="bs">
