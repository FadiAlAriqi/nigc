    ...
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-md-6 text-center text-md-start mb-md-0">
                <span class="text-white"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i>NiGC</a>
                    {{__('dashboard.distributed_by')}} <a class="border-bottom text-white" href="">{{__('dashboard.A & F')}}</a>
                </span>
            </div>
